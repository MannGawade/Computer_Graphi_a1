...
namespace
{
    ...
    void drawScene(void)
    {
        ...
        glRasterPos2i(10, 20);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)" 'c' to curve display.");
        glRasterPos2i(10, 40);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)" 's' to surface display ");
        glRasterPos2i(10, 60);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)" 'p' to point display ");
        glRasterPos2i(10, 80);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)" SPACE to reset.");
        glRasterPos2i(10, 100);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)"Use mouse to rotate view");
        glRasterPos2i(10, 120);
        glutBitmapString(GLUT_BITMAP_HELVETICA_12, (unsigned char*)"ESC to quit.");
...
int main( int argc, char* argv[] )
{
    ...
    glutCreateWindow("Mann Gawade Assignment 1");
